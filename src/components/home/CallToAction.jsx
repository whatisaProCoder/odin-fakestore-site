...
function CallToAction() {
  return (
    <div className="flex flex-col justify-center items-center bg-linear-to-br from-[#2573E9] to-[#3237A1]">
      <div className="py-16 max-sm:py-10 max-w-350 px-20 max-sm:px-10 w-full flex flex-row max-sm:flex-col justify-between items-center border-b border-[rgba(255,255,255,0.87)]">
