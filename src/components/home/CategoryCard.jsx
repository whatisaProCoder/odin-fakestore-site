function CategoryCard({ categoryImage, name }) {
  return (
    <div className="flex flex-col justify-center px-4 py-6 items-center border border-[#202227] rounded-2xl transition-all duration-300 bg-[#14161a] hover:bg-[#1b1d20]">
